...
{
    /// <inheritdoc />
    public partial class AddOrderCommerceFeatures : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(
                "UPDATE Orders SET OrderNumber = CONCAT('ORD-LEGACY-', OrderId), SubTotal = TotalAmount WHERE OrderNumber = ''");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropColumn(name: "DeliveryCharge", table: "Orders");
